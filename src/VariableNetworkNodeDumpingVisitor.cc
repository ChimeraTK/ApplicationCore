...
namespace ChimeraTK {
  ...
  VariableNetworkNodeDumpingVisitor::VariableNetworkNodeDumpingVisitor(std::ostream& stream, std::string separator)
  : Visitor<ChimeraTK::VariableNetworkNode>(), PushableStream(stream), _separator(std::move(separator)) {}
