...
class MyMod(PyApplicationCore.ApplicationModule):
    ...
    def __init__(self, owner, name, description):
        ...
        self.myOutput = PyApplicationCore.ScalarOutput(
            PyApplicationCore.DataType.float32, self, "/Var1", "unit", "description")
        self.myInput = PyApplicationCore.ScalarPushInput(
            PyApplicationCore.DataType.int32, self, "/Var2", "unit", "description")
