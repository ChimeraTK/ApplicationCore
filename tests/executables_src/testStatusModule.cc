...
BOOST_AUTO_TEST_CASE(testMaxMonitor2) {
  std::cout << "testMaxMonitor2" << std::endl;
  TestApplicationNewInterface<ctk::MaxMonitor2<double_t>> app;
...
BOOST_AUTO_TEST_CASE(testMinMonitor2) {
  std::cout << "testMinMonitor2" << std::endl;

  TestApplicationNewInterface<ctk::MinMonitor2<uint>> app;
...
BOOST_AUTO_TEST_CASE(testRangeMonitor2) {
  std::cout << "testRangeMonitor2" << std::endl;
  TestApplicationNewInterface<ctk::RangeMonitor2<int>> app;
