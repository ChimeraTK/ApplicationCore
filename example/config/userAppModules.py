...
class SetpointRamp(ac.ApplicationModule):
    ...
    def mainLoop(self):
        ...
        while True:
            ...
            # syntax like self.ctrl.actualSetpoint = self.ctrl.actualSetpoint+1 does
            # _not_ work since it overwrites the accessor reference by a float.
            self.ctrl.actualSetpoint.set(self.ctrl.actualSetpoint +
                                         max(min(self.operatorSetpoint - self.ctrl.actualSetpoint, maxStep), -maxStep))
